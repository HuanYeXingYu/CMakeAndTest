...
import com.nzsc.cmakeandtest.Entity.UType;
import com.nzsc.cmakeandtest.R;

import java.util.Calendar;
import java.util.List;

public class VectorgraphView extends View {
    //View默认最小宽度
    ...
    public VectorgraphView(Context context) {
        super(context);

        init();
    }

    public VectorgraphView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public VectorgraphView(Context context, AttributeSet attrs, int defStyleAttr) {
